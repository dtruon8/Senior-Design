...
var saved = false;		//keeps track of whether assessment progress has been saved. UNIMPLEMENTED
...
function initialize(){
	...
	for (var i = 0; i < numSec; i++){
		...
		//tempArray.fill(false, 0, secNumQ); //not supported by IE. equivalent to following loop
		for (var j = 0; j < secNumQ; j++){
			tempArray[j] = false;
		}
		numberAnswered[i] = 0;
